...
#   #Further
    ...
    def test_volume_of_cube(self):
        volume_of_cube = calculate_cube_volume( 3 )
        self.assertEqual( 27, volume_of_cube )

    #Given a String, return the String reversed
    def test_reverse_string(self):
        string_reversed = reverse_string("test string")
        self.assertEqual("gnirts tset", string_reversed)

    #Given a value in farenheit, convert this into celsius.
    def test_fahrenheit_to_celsius(self):
        value_in_celsius = convert_farenheit_to_celsius(32)
        self.assertEqual(0, value_in_celsius)
